    ...
    function viewTable(){
        ...
        while($l = mysqli_fetch_array($result)){
            ...
            if($cor == 0){
                ...
                $this->Cell(80,7,utf8_decode($l['SOC_NOME']),0,0,'L');
                $this->Cell(30,7,utf8_decode($situacao),0,0,'C');
                $this->Cell(50,7,utf8_decode($cargo),0,0,'C');
                $this->Cell(25,7,utf8_decode($l['SOC_CPF']),0,0,'C');
                $this->Cell(65,7,utf8_decode(''),0,1,'C');
            }else{
                $cor = 0;
                $this->SetFont('arial','B',8);
                ...
                $this->Cell(80,7,utf8_decode($l['SOC_NOME']),0,0,'L',true);
                $this->Cell(30,7,utf8_decode($situacao),0,0,'C',true);
                $this->Cell(50,7,utf8_decode($cargo),0,0,'C',true);
                $this->Cell(25,7,utf8_decode($l['SOC_CPF']),0,0,'C',true);
                $this->Cell(65,7,utf8_decode(''),0,1,'C',true);
            }
