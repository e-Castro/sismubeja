...
<body>
    ...
    <table width='900' border=0px font size=5 align='center'>
        <tr align="center">
            <td>
    ...
    <table width='800' border=0px font size=5 align='center'>
        <tr align="right">
            <td>
                <input type="button" value="Voltar" onClick="history.go(-1)" /> <input type="button" value="Imprimir" onclick="window.print()" />
            </td>
        </tr>
    </table>
    ...
    <TABLE width="800" ALIGN="CENTER" BORDER="0">
        <TR>
            <TD colspan="6" size="150" bgcolor="#FF7F00"><B>DADOS PESSOAIS:</B></TD>
        </TR>
        <TR>
                                ...
                                <TR>
                                    <TD>
                                        ...
                                        while ($usuario = mysqli_fetch_object($sql)) {
                                            // Exibimos a foto
                                            if ($usuario->SOC_FOTO == '') {
                                                echo "<img src='fotos/user.jpg' width='160' height='180' alt='Foto de exibição' /><br />";
                                            } else {
                                                echo "<img src='fotos/" . $usuario->SOC_FOTO . "' width='160' height='180' alt='Foto de exibição' /><br />";
                                            }
                                        } ?>
                                    </TD>
                                </TR>
        ...
        <TR>
            ...
            <TD COLSPAN="3"><input type="text" size="60" name="nome" value="<?php echo $dados["SOC_NOME"]; ?>" /></TD>
        </TR>
        <TR>
        ...
        <TR>
            ...
            <TD colspan=1><input type="text" size="18" name="nacionalid" value="<?php echo $dados["SOC_NACION"]; ?>"></TD>
            <TD colspan=1><input type="text" size="18" name="naturalid" value="<?php echo $dados["SOC_NATURALID"]; ?>"></TD>
        </TR>
        <TR>
        ...
        <TR>
            ...
            <TD colspan=2><input type="text" size="39" name="apelido" value="<?php echo $dados["SOC_APELIDO"]; ?>"></TD>
        </TR>
        <TR>
            <TD colspan="6"> Pai: <input type="text" size="74" name="pai" value="<?php echo $dados["SOC_PAI"]; ?>"></TD>
        </TR>
        <TR>
            <TD colspan="6">M&atilde;e: <input type="text" size="73" name="mae" value="<?php echo $dados["SOC_MAE"]; ?>"></TD>
        </TR>
    </TABLE>
    ...
    <TABLE TABLE width="800" ALIGN="CENTER" BORDER="0">
        ...
        <TR>
            <TD>RG/ORG.:</TD>
            <TD>RG/Exprdi&ccedil;&atilde;o:</TD>
            <TD>RG/UF:</TD>
            <TD>CPF:</TD>
        </TR>
        <TR>
        ...
        <TR>
            <TD colspan="2">N&iacute;vel/Forma&ccedil;&atilde;o:</TD>
            <TD>PIS:</TD>
        </TR>
        <TR>
            <TD COLSPAN="2">
        ...
        <TR>
            <TD COLSPAN="2">Institui&ccedil;&atilde;o:</TD>
            <TD>Cargo:</TD>
        </TR>
        <TR>
            <TD COLSPAN="2">
        ...
        <TR>
            <TD COLSPAN="2">Lota&ccedil;&atilde;o:</TD>
            <TD>Cargo de Lota&ccedil;&atilde;o:</TD>
        </TR>
        <TR>
            <TD COLSPAN=2>
                <SELECT name="lotacao">
    ...
    <TABLE TABLE width="800" ALIGN="CENTER" BORDER="0">
        ...
        <TR>
            ...
            <TD>N. Port. Admiss&atilde;o:</TD>
            <TD>Data Admiss&atilde;o:</TD>
            <TD>N. Port. Aposetadoria:</TD>
            <TD>Data Aposentadoria:</TD>
        </TR>
        <TR>
            <TD>
                <SELECT name="sit">
        ...
        <BR>
        <TR>
            <TD COLSPAN="6">Obs:<input type="text" size="104" name="obs" value="<?php echo $dados["SOC_OBS"]; ?>"></TD>
            </TD>
        </TR>
    </TABLE>
    <TABLE TABLE width="800" ALIGN="CENTER" BORDER="0">
        ...
        < </TABLE> <table width='800' border=0px font size=5 align='center'>
            <tr align="left">
                <td>
                    <img src="images/cabecalhonet.png">
                </td>
            ...
            <tr align="center">
                <td>
                    <p align="justify">Eu, <?php echo $dados["SOC_NOME"]; ?> Matr&iacute;cula: <?php echo $dados["SOC_MAT"]; ?>, autorizo o desconto em folha de pagamento
                        da minha contribui&ccedil;&atilde;o mensal em favor do Sindicato dos servidores P&uacute;blicos Municipais da Administra&ccedil;&atilde;o Direta e Indireta de Belo Jardim,
                        no valor correspondente a 02&permil; (dois por cento) sobre os meus vencimentos, a partir de <b><?php echo $meses[date('m')] . " de 20" . date('y'); ?></b>
                        s&oacute; deixando de ser feito este desconto quando em processo legal, deixar requerimento ao quadro deste Sindicato e depois de feito a necess&aacute;ria
                        comunica&ccedil;&atilde;o pelo Sindicato a Administra&ccedil;&atilde;o Munipipal de belo Jardim.</p>
                </td>
            </tr>
    </table>
    <TABLE TABLE width="800" ALIGN="CENTER" BORDER="0">
