...
class myPDF extends FPDF {
    ...
    function viewTable(){
        ...
        $result = exeBD("SELECT * from sociosb WHERE SOC_SITUAC LIKE 1 AND SOC_BAIRRO LIKE '%$bairro%'|| SOC_SITUAC LIKE 2 AND SOC_BAIRRO LIKE '%$bairro%'|| SOC_SITUAC LIKE 7 AND SOC_BAIRRO LIKE '%$bairro%' order by SOC_NOME asc");
