...
class myPDF extends FPDF {
    ...
    function viewTable(){
        ...
        $result = exeBD("SELECT * FROM sociosb WHERE SOC_SITUAC LIKE 1 || SOC_SITUAC LIKE 2 || SOC_SITUAC LIKE 7 AND SOC_BAIRRO LIKE '%$bairro%' order by SOC_NOME asc");
        ...
        while($l = mysqli_fetch_array($result)){
            ...
            if($cor == 0){
                ...
                $this->Cell(30,7,utf8_decode($l['SOC_BAIRRO']),0,0,'L');
                $this->Cell(30,7,$situacao,0,0,'C');
                $this->Cell(25,7,$l['SOC_CPF'],0,0,'C');
                $this->Cell(75,7,'',0,1,'C');
            }else{
                $cor = 0;
                $this->SetFont('arial','B',8);
                ...
                $this->Cell(30,7,utf8_decode($l['SOC_BAIRRO']),0,0,'L', true);
                $this->Cell(30,7,$situacao,0,0,'C',true);
                $this->Cell(25,7,$l['SOC_CPF'],0,0,'C',true);
                $this->Cell(75,7,'',0,1,'C',true);
            }
