...
// para utiliza essa classe deve existir um (require_once("backend/vextenso.php") na pagina q vai chamar a função abaixo.)
echo vextenso::converte("1025,10", true, false);