...
if ($situac == 3 || $situac == 5){
   ...
   SOC_DTADMISSAO2='$dtadmissao2', SOC_PORT_ADMIS2='$portadmis2', SOC_DTDESF='$timestamp' 
   WHERE SOC_COD = $cod");
   
   if($situac == 5)$valor = exeBD("INSERT INTO `desfiliacoes`(`DES_COD`, `DES_SOC_COD`, `DES_DATA`, `DES_OPERADOR`) VALUES (default, $cod, '$timestamp', '$repres')");
