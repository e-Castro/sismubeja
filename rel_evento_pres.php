...
class myPDF extends FPDF {
    ...
    function header(){
        ...
        $this ->Cell(278,5,utf8_decode('SISMUBEJA - Sindicato dos Servidores Públicos Mun. da Administração Direta e Indireta do Belo Jardim.'),0,1,'C');

        $this ->setFont('arial', 'B', 10);
        $this ->Cell(278,5,utf8_decode("Lista de Presença: $evento"),0,1,'C');
        ...
        $this->Cell(15,7,'COD.',0,0,'C');
        $this->Cell(90,7,utf8_decode('NOME DO SÓCIO'),0,0,'L');
        $this->Cell(40,7,utf8_decode('SITUAÇÃO'),0,0,'C');
        $this->Cell(25,7,'CPF',0,0,'C');
        $this->Cell(100,7,'ASSINATURA',0,1,'C');
        $this ->setFont('arial', '', 8);
        $this->Cell (0,1,"","B",1,"C");
