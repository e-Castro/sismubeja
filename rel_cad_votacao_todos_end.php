...
class myPDF extends FPDF {
    ...
    function header(){
        ...
        $this ->Cell(278,5,utf8_decode("Relátorio por Bairro: Sócios Ativos/Aposentados/Pensionistas"),0,1,'C');
    ...
    function viewTable(){
        ...
        $result = exeBD("SELECT * from sociosb WHERE SOC_SITUAC LIKE 1 AND SOC_BAIRRO LIKE '%$bairro%'|| SOC_SITUAC LIKE 2 AND SOC_BAIRRO LIKE '%$bairro%'|| SOC_SITUAC LIKE 7 AND SOC_BAIRRO LIKE '%$bairro%' order by SOC_END asc");
